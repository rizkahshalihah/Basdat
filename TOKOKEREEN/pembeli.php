							...
							<div class="product-image-wrapper">
								<div class="single-products">
									<div class="productinfo text-center">
										...
										<h2>RP.560.000</h2>
										<p>Men's Sweater</p>
										<a href="#" class="btn btn-default add-to-cart"><i class="fa fa-shopping-cart"></i>Beli Sekarang</a>
									</div>
								...
								<div class="choose">
									<ul class="nav nav-pills nav-justified">
										...
										<li><a href="html.komentarulasan"><i class="fa fa-plus-square"></i>Diskusikan Produk</a></li>
									</ul>
								</div>
							</div>
						</div>
